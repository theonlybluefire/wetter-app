          ...
          <div>
            <AnimatePresence>
              {(noResults) &&
                ...
                >
                  <div className='bg-zinc-900 md:w-1/3 md: h-2/4 w-full h-full grid grid-cols-1 items-center justify-items-center p-8 rounded-3xl'>
                    <svg  width="300px" height="300px" viewBox="0 0 32 32" enable-background="new 0 0 32 32" id="_x3C_Layer_x3E_" version="1.1" >
                    ...
                    <h2 className={tempColor}>NO RESULTS </h2>
